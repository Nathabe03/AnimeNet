...
export function createCard(item) {
    ...
    // Verifica se há progresso para adicionar a classe CSS
    if (item.progress > 0) {
    ...
    // Ordem de inserção: O iframe fica por baixo da imagem até o hover
    ...
    details.innerHTML = `
        <div class="details-buttons">
            <div class="left-buttons">
                ...
                ${item.progress > 0 ? '<button class="btn-icon"><i class="fas fa-check"></i></button>' : '<button class="btn-icon"><i class="fas fa-plus"></i></button>'}
